...
1. Start with INEGI DENUE sector 71 for 2019-2024.
...
**Temporary 2025 gapfill:** DENUE 2025 is not yet available. For the SP merge, 2025 is temporarily copied from 2024 until DENUE 2025 is released. The observed 2019-2024 series remains unchanged so this can be reversed later.

**Data sources**

- INEGI DENUE sector 71 cultural and recreation establishments within the inland 10 km coastal buffer; employees estimated from DENUE size classes, scaled to coastal locality population, referenced to the 75th quantile; 2025 temporarily copied from 2024 until DENUE 2025 is released
...
sp_plotly_lines(
  cult_cs,
  "final_score",
  "CURRENT STATUS: Non-natural cultural places (employees per coastal pop, 75th quantile; 2025 gapfilled)"
)
```
...
After discussion, we decided **not** to include these indicators in the published CCE score for this assessment cycle.

The reasons are about consent, nuance, and capacity, not about importance:
...
- There are important nuances. For example, the Tohono O'odham has decided internally that it does not want to be considered a pueblo originario. Any indicator built only on official categories would miss that kind of self determination.
...
Because of this, language recognition, justice plans, and indigenous development centers were moved to **Tier 2**: ideas we want group input on, not indicators we are ready to score as if they represent community values.
...
1. Whether a future Tier 2 track on community defined indicators of support and recognition is the right path.
2. How to keep acknowledging pueblos originarios clearly on the website and in communications without extracting or scoring what we have not been invited to score.
3. How stakeholder invitations can be respectful, practical, and community led.

If you have contacts, cautions, or preferred language for this acknowledgment, please bring them to the meeting or share them ahead of time.
