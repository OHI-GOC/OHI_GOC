...
- [Meeting #3 Slides](https://docs.google.com/presentation/d/10OyGhotTnMNjNQifGOFAPbqshcNs2RidIebrOIKgRyY/edit?slide=id.g38e684abb2a_0_14#slide=id.g38e684abb2a_0_14)
- [Meeting #4 Slides](https://docs.google.com/presentation/d/1cqnvTUj-zreseBhHRimJpN37JDsk0ZAG4ndKAFyMa5E/edit?slide=id.g3a0be70a506_0_586#slide=id.g3a0be70a506_0_586)
...
::: {.callout-note collapse="true"}
# <i class="fa-regular fa-clipboard"></i> **Meeting #4:** LE Model, Data Sources & Job/Revenue Metrics
...
### **4. Economies: Marine-related Revenue**
We reviewed the revenue metrics from SAIC, including:

- Total revenue from goods and services (M000A)  
- Revenue from merchandise resale (M010A)  
- Revenue from professional/technical services (M020A)  
- Revenue from manufactured/extracted products (M030A)  
- Rental income (M050A)  
- Maquila services (M700A)  
- Other income (M090A)  
- Total revenue across all sources (A800A)

Revenue must be **inflation-adjusted** before calculating the current status.

As with jobs and job quality, sectors use either a **government target** (if available) or a **2018 baseline**.
...
For all others:
- Use **SAIC** as the primary source for jobs, job quality, and revenue.  
