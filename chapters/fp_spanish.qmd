...
::: {.callout-note collapse="true"}
## **Resumen de la Reunión #3 de FP** - *PRÓXIMAMENTE 23 de septiembre*
**En la Reunión #3**, vamos a finalizar la definición de 'Provisión de Alimentos' en el Golfo y a discutir los indicadores del modelo. **Piensa en qué indicadores (variables) deberíamos incluir en nuestro modelo para Provisión de Alimentos.** Llega preparado/a para hablar de esto y de fuentes de datos relevantes más allá de CONAPESCA. Si usamos datos de CONAPESCA, ¿qué especies crees que serán problemáticas o más difíciles de evaluar?

**Recursos compartidos durante la Reunión #3 de Provisión de Alimentos (FP)**
