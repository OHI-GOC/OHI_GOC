...
# NOTE: this is the well-curated "Welcome" page (aka index.qmd) for the website when it is public facing.  For the subregion determination, I (sophia) don't want to confuse anyone and have the map on the index.qmd so there is only one page where they cannot miss it.
...
Since it’s inception in 2012, we have conducted 13 global assessments, and over [30 regional assessments](https://oceanhealthindex.org/ohi+/assessment/) have been conducted independently, or in partnership us.
