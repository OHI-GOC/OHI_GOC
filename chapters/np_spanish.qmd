...
- [Presentación de PowerPoint compartida por Liliana](https://docs.google.com/presentation/d/1HpaWFFdYJWdCv8Pjls8jI-MPyPLg99nc/edit?usp=share_link&ouid=101513442493251196406&rtpof=true&sd=true)  
: por favor, revisa la presentación de Liliana sobre productos naturales en la región. ¡Es increíblemente útil!

- [Actividad grupal en pizarra](https://drive.google.com/drive/u/1/folders/11vzy2cgSxRSWaPTaHIKawYgynVozh0yl)  
...
**Tarea para la Reunión #3 de NP:** Por favor, ven preparado/a para discutir indicadores del objetivo y posibles fuentes de datos. Ten en cuenta que nuestra definición de trabajo captura la *intención* del objetivo, mientras que los indicadores representan los tipos específicos de datos que usaremos para cuantificar el estado del objetivo.
:::

::: {.callout-note collapse="true"}
## **Resumen de la Reunión #3 de NP** - *PRÓXIMAMENTE el 25 de septiembre*
**En la Reunión #3**, discutiremos los indicadores del modelo. **Por favor, ven preparado/a para hablar sobre los indicadores del objetivo y posibles fuentes de datos.** Recuerda que nuestra definición de trabajo captura la *intención* del objetivo, mientras que los indicadores representan los tipos específicos de datos que utilizaremos para cuantificar el estado del objetivo.
