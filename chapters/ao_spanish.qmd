...
::: {.callout-note collapse="true"}
## **Resumen de la Reunión #3 de OA** - *PRÓXIMAMENTE 23 de septiembre*
**En la Reunión #3**, vamos a finalizar la definición de 'Oportunidades Artesanales' en el Golfo y a discutir los indicadores del modelo. **Piensa en qué indicadores (variables) deberíamos incluir en nuestro modelo de OA.** Llega preparado/a para conversar sobre los indicadores y las fuentes de datos relevantes.

**Recursos compartidos durante la Reunión #3 de Oportunidades Artesanales (AO)**
...
: presentación para guiar nuestra conversación.
<!-- - [Resumen y Notas Generales de la Reunión #3](https://docs.google.com/document/d/1XjBi0qHSjbso1bPnc48mBbsjcm08wJig0kZueTe4PMQ/edit?pli=1&tab=t.si1a55fewcmq) -->
<!-- : revisa las reuniones que te perdiste y repasa los resúmenes; lleva un registro de los recursos y bases de datos compartidos, y anota tus ideas por fuera de las reuniones. -->
...
: revisa la actividad grupal compartida durante la reunión, donde se pidió a los participantes ayudar a identificar posibles indicadores y fuentes de datos.
