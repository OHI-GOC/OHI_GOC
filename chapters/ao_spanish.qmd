...
::: {.callout-tip}
# **Nueva Definición Provisional**

Esta definición fue establecida por el Grupo de Guardianes de la Meta durante la Reunión #2. Consulta la pestaña de abajo para más detalles.  

**_Las condiciones que permiten a los miembros de comunidades pesqueras a pequeña escala y pueblos originarios prosperar, incluyendo acceso legal y regulado a los recursos marinos, reglas de uso basadas en conocimiento, límites claros, espacios de toma de decisiones bien definidos y un seguimiento confiable para garantizar acceso, sostenibilidad y equidad a largo plazo._**  
...
*Los recursos compartidos durante nuestras reuniones están disponibles en el [Google Drive del grupo](https://drive.google.com/drive/u/0/folders/1VUuocKEk9TqgssSgzeFb6y5LGtEoKQ2a).*
