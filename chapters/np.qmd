...
- [Powerpoint presentation shared by Liliana](https://docs.google.com/presentation/d/1HpaWFFdYJWdCv8Pjls8jI-MPyPLg99nc/edit?usp=share_link&ouid=101513442493251196406&rtpof=true&sd=true)
: please review Liliana's presentation on natural products in the region! It is incredibly helpful.
- [Whiteboard Group Activity](https://drive.google.com/drive/u/1/folders/11vzy2cgSxRSWaPTaHIKawYgynVozh0yl)
...
**Homework for NP Meeting #3:** Please come prepared to discuss goal indicators and possible data sources. Keep in mind that our working definition captures the *intent* of the goal, whereas indicators represent the specific types of data we will use to quantify the goal's status.
:::

::: {.callout-note collapse="true"}
## **NP Meeting #3 Summary** - *UPCOMING September 25*
**In Meeting #3**, we will discuss model indicators. **Please come prepared to discuss goal indicators and possible data sources.** Keep in mind that our working definition captures the *intent* of the goal, whereas indicators represent the specific types of data we will use to quantify the goal's status.
