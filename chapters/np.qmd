...
**In Meeting #3**, we will discuss model indicators, data sources, and technical reference points. **Please review the list of natural products and come prepared to discuss goal indicators.** Keep in mind that our working definition captures the *intent* of the goal, whereas indicators represent the specific types of data we will use to quantify the goal's status.

**Resources shared during NP Meeting #3**

- [Meeting #3 Presentation Slides](https://docs.google.com/presentation/d/1P0WU1V1x5A_E9xgUc18bsogD7DLyyCalKtKm97Px46k/edit?slide=id.g380ae5a8885_0_7#slide=id.g380ae5a8885_0_7)
