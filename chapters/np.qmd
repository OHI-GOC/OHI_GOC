...
::: {.callout-tip}
# **Working List of Natural Products**

As of Meeting #2 (August, 2025) (under construction)
...
[Working list](https://docs.google.com/spreadsheets/d/1W79dH11jelVMsHhUBHvsr1pt-zhFYFqikUCcIl3glfc/edit?gid=0#gid=0) as of end Meeting 3 (October, 2025).
:::

::: {.callout-note collapse="true"}
## NP **Meeting #1: Summary** - July 31
...
::: {.callout-note collapse="true"}
## **NP Meeting #2 Summary** - August 28
...
**Homework for NP Meeting #3:** Please review the list of natural products and come prepared to discuss goal indicators, data sources, and technical reference points. Keep in mind that our working definition captures the *intent* of the goal, whereas indicators represent the specific types of data we will use to quantify the goal's status.

:::

::: {.callout-note collapse="true"}
## **NP Meeting #3 Summary** - September 25
**In Meeting #3**, the team explored various data sources and technical reference points for each product identified last meeting (see working list of natural products above). Most of the discussion was focused on how to establish a technical reference point for each product, given data constraints. In particular, the team discussed challenges in data collection for small-scale operations. Members analyzed specific natural products, including salt production and marine algae, and discussed how to assess the sustainability of each product.

**Resources shared during NP Meeting #3**

- [Meeting #3 Presentation Slides](https://docs.google.com/presentation/d/1P0WU1V1x5A_E9xgUc18bsogD7DLyyCalKtKm97Px46k/edit?slide=id.g38342a57b8b_1_2#slide=id.g38342a57b8b_1_2)
: slides to guide our discussion.
- [Meeting #3 Summary & General Notes](https://docs.google.com/document/d/11LrbOWL7UnQ2SU3u-POucAdKruhMNsFJ6rCkEMtNIqI/edit?tab=t.gb2sy7trdzk7)
: catch up on meetings you missed and review meeting summaries; keep track of resources and data bases shared during our meetings, and write down your thoughts offline.
- [Group Activity - Identifying Indicators](https://docs.google.com/document/d/1x2Uez1Gl2FIRHkNtrO2bsXqID8nvRx4GqLptpG4IHAU/edit?tab=t.0)
...
**Plan for NP Meeting #4:** Erica will come with a preliminary NP "dummy" model for the group to think about and critique, and we will continue our discussion of technical reference points given available data sources. 

Keep in mind that a technical reference point for each indicator will be critical as it is essentially a goal "baseline". If an indicator does not have a technical reference point associated with it, it will be difficult if not impossible for us to parameterize it within the goal model. So, we might have to get creative in terms of selecting reference points for this goal... *Exciting!* **Please come prepared to share your perspective on these important topics.**

:::

::: {.callout-note collapse="true"}
## **NP Meeting #4: Summary** - November 20
**In Meeting #4**, the team discussed two important topics:

- **First, the team discussed the proposed method of scoring the NP goal.** They agreed that the goal model should include some estimate of total production, product ‘use value’, product ‘potential’, product sustainability, and data completeness. Product use value, potential, and sustainability can be determined by expert opinion, whereas total production (e.g., total kilograms of algae, fish oil, etc.) and data completeness will be calculated by members of the OHI Core Team. This handful of indicators may help us overcome issues of low data availability. For example, a product like cultured algae may have low data availability and low total production but high use value and high potential. In contrast, a product like shark fin might have high data availability and high total production but low sustainability. Group members discussed how to penalize certain products like shark fin for their negative impacts on biodiversity and conservation.

- **Second, the group discussed how to use the CONAPESCA database to estimate production of key natural products**, including fishery residues (sea shells, shrimp heads, bladder, and fins), fish oil, ornamental fishes, some species used for crafts (like pearl oysters and sea stars), and algaes. They reviewed various natural products and their traditional uses, while also exploring potential future applications and classification approaches for these products.

- The group agreed to continue refining their product list and measurement approaches, with plans to reconvene in the new year.
**There is no "homework" for the next meeting. Enjoy the holidays and we look forward to seeing you again in the new year!**

**Resources shared during NP Meeting #4**

- [Meeting #4 Presentation Slides](https://docs.google.com/presentation/d/1UvpRqNRt3JvzaUPiyuVzH4UhHAdBfdMSTqayVzV_VOU/edit?slide=id.g380ae5a8885_0_13#slide=id.g380ae5a8885_0_13)
: slides to guide our discussion.
- [Meeting #4 Summary & General Notes](https://docs.google.com/document/d/11LrbOWL7UnQ2SU3u-POucAdKruhMNsFJ6rCkEMtNIqI/edit?tab=t.ovvomwjhei19)
: catch up on meetings you missed and review meeting summaries; keep track of resources and data bases shared during our meetings, and write down your thoughts offline.
- [Group Activity - Review of NP Keywords in the CONAPESCA Database](https://docs.google.com/spreadsheets/d/1e8iAHpSMGOND_ea7xF6CZh70LdsIlZ5GAldNFOTsS68/edit?gid=1380842822#gid=1380842822)
: review keywords from the CONAPESCA database that we have identified as possible "flags" for natural products. For example, "aleta", "descabezado", "carnada".
:::

::: {.callout-note collapse="true"}
## **NP Meeting #5** *UPCOMING Winter 2026*
Please keep an eye on your email for details regarding NP Meeting #5! 
:::
