...
> 2. Should we move the Region 6 boundary to just south of el Choyudo (so region 6 will include el Choyudo), currently it is just north of el Choyudo (and el Choyudo is in Region 7).   
...
| **Region 3** Central Gulf, Baja Sur | BC/BCS state line to just south of San Basilio ([reference](https://nextgensd.com/wp-content/uploads/2020/07/San-Basilio-Master-DIGITAL-10-08-20.pdf)). |
